...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet UpdateNewProduct</title>");
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet UpdateNewProduct at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
...
//        PrintWriter out = response.getWriter();
        if (id != null) {
            ...
            ArrayList<OptionProduct> lstT = dao.getOptionPro();
            ArrayList<Product> lstP = dao.getProduct();
            request.setAttribute("pr", product);
            request.setAttribute("listC", lstCategory);
            request.setAttribute("pr", product);
            request.setAttribute("listO", lstT);
            request.setAttribute("listOP", st);
            request.setAttribute("listP", lstP);
            request.setAttribute("pr", product);
//            out.println(product);
            request.getRequestDispatcher("./Views/shop/updateProduct.jsp").forward(request, response);
        }
