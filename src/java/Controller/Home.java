...
//        processRequest(request, response);
        ...
        if (ses.getAttribute("keyS") != null) {
            ses.removeAttribute("keyS");
        }
        request.setAttribute("listC", lstCate);
        request.setAttribute("listCate", dao.getCategory());
        request.setAttribute("listP", lstProduct);
        request.setAttribute("listOp", st);
//        out.println(lstCate);

        request.getRequestDispatcher("./Views/US/Home.jsp").forward(request, response);
    }
