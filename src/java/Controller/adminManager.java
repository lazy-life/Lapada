...
//        processRequest(request, response);
        String admin = request.getParameter("keyname");
        String[] strSplit = admin.split("-");
        String status = strSplit[0]; // 004
        int sta = Integer.parseInt(status);
        String id = strSplit[1]; // 034556
        DAO dao = new DAO();
        dao.UpdateUserStatus(id, sta);
    }
